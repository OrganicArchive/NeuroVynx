...
from app.api import upload, session, baseline, artifact, plugins, readiness
...
app.include_router(readiness.router, prefix=settings.API_V1_STR + "/readiness", tags=["Readiness"])
